        ...
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-none">
              <span className="text-base font-semibold tracking-wide dark:text-text-primary text-text-light">
                Remi
              </span>
              <span className="text-sm font-semibold tracking-[0.18em] uppercase dark:text-text-secondary text-text-light-secondary">
                Adventures
              </span>
            </div>
          </div>
